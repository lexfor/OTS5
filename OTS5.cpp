...
// OTS5.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(COTS5App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &COTS5App::OnAppAbout)
...
COTS5App::COTS5App() noexcept
{
	...
	SetAppID(_T("OTS5.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект COTS5App

COTS5App theApp;


// Инициализация COTS5App

BOOL COTS5App::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_OTS5TYPE,
		RUNTIME_CLASS(COTS5Doc),
		RUNTIME_CLASS(CChildFrame), // настраиваемая дочерняя рамка MDI
		RUNTIME_CLASS(COTS5View));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений COTS5App
...
void COTS5App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Методы загрузки или сохранения настроек COTS5App

void COTS5App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void COTS5App::LoadCustomState()
{
}

void COTS5App::SaveCustomState()
{
}
